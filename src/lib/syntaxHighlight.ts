...
export function highlightCode(code: string, language: string) {
  ...
  if (language === "mst") {
    return escaped
      .replace(
        /(^|\s)(master|field|relation|validation|assert|scope|static|filter)\b/g,
  ...
  return escaped
    .replace(/(&quot;[^&]*?&quot;|&#39;[^&]*?&#39;)/g, '<span class="token-string">$1</span>')
    .replace(
      /\b(const|let|var|func|function|return|type|interface|class|public|private|namespace|using|package|import|struct|if|else|for|switch|case|new)\b/g,
