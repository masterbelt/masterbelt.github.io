        ...
        <div className="mx-auto grid min-h-[520px] w-[min(1120px,calc(100%-32px))] grid-cols-1 items-center gap-10 py-14 md:grid-cols-[1.1fr_0.9fr] md:gap-14">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a className="inline-flex min-h-11 items-center rounded-md border border-teal-900 bg-teal-900 px-5 font-bold text-white no-underline" href="/spec/">Spec</a>
              <a className="inline-flex min-h-11 items-center rounded-md border border-teal-900 px-5 font-bold text-teal-900 no-underline" href="https://github.com/masterbelt">GitHub</a>
            </div>
          </div>
          ...
          <aside className="grid gap-3 rounded-lg border border-zinc-200 bg-white/75 p-6" aria-label="Site status">
            ...
            <StatusRow label="Specs" value={`${specs.length} synced pages`} />
          </aside>
        </div>
      </section>
